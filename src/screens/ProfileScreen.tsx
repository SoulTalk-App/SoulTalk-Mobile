...
const ProfileScreen = ({ navigation }: any) => {
  ...
  // so-loo3: tab raise/label animations live in BottomTabBar now. Only
  // the outer scroll-hide translateY stays here.
        ...
        >
          ...
          <View style={dk.avatarContainer}>
            <View style={dk.avatarCircle}>
              <SoulPalAnimated pose="default" size={90} animate={false} colorId="blue" />
            </View>
          </View>
          ...
          <GlassCard style={dk.soulPalCard}>
            <View style={dk.soulPalCardInner}>
              <View style={dk.soulPalCharArea}>
                <SoulPalAnimated pose="celebrating" size={65} animate={true} colorId="blue" />
              </View>
