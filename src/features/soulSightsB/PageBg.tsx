...
export function PageBg({ theme }: { theme: Theme }) {
    ...
    return (
      <>
        ...
        <Svg style={StyleSheet.absoluteFill} preserveAspectRatio="none" viewBox="0 0 100 100">
          <Defs>
            <RadialGradient id="dk-rad-1" cx="30%" cy="5%" r="50%">
              <Stop offset="0%" stopColor="#70CACF" stopOpacity={0.30} />
              <Stop offset="100%" stopColor="#70CACF" stopOpacity={0} />
            </RadialGradient>
            <RadialGradient id="dk-rad-2" cx="80%" cy="90%" r="55%">
              <Stop offset="0%" stopColor="#E93678" stopOpacity={0.22} />
              <Stop offset="100%" stopColor="#E93678" stopOpacity={0} />
            </RadialGradient>
          </Defs>
          <Rect x="0" y="0" width="100" height="100" fill="url(#dk-rad-1)" />
          <Rect x="0" y="0" width="100" height="100" fill="url(#dk-rad-2)" />
        </Svg>
      </>
    );
  }
  return (
    <>
      ...
      <Svg style={StyleSheet.absoluteFill} preserveAspectRatio="none" viewBox="0 0 100 100">
        <Defs>
          <RadialGradient id="lt-rad-1" cx="30%" cy="0%" r="60%">
            <Stop offset="0%" stopColor="#F0EAFF" stopOpacity={1} />
            <Stop offset="100%" stopColor="#F0EAFF" stopOpacity={0} />
          </RadialGradient>
          <RadialGradient id="lt-rad-2" cx="80%" cy="80%" r="50%">
            <Stop offset="0%" stopColor="#E93678" stopOpacity={0.10} />
            <Stop offset="100%" stopColor="#E93678" stopOpacity={0} />
          </RadialGradient>
        </Defs>
        <Rect x="0" y="0" width="100" height="100" fill="url(#lt-rad-1)" />
        <Rect x="0" y="0" width="100" height="100" fill="url(#lt-rad-2)" />
      </Svg>
    </>
  );
}
